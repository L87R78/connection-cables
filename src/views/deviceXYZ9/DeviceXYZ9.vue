<template>
    <div class="deviceXYZ9">
      <table class="tableBody">
        <caption class="tableTitle">{{ `Device XYZ9` }}</caption>
        <thead>
          <tr>
        ...
        <tbody>
          <tr v-for="device in storeDevices.devicesData.filter(device => device.deviceName === 'XYZ9')" :key="device.id">
  ...
  <style lang="scss">
  @import '@/views/deviceXYZ9/DeviceXYZ9.module.scss';
  </style>
